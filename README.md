...
# Adaptive Self-RAG Studio

![Demo Screenshot](demo/screenshot.png)

## Overview
Build a production-facing RAG system that decides when to retrieve, critiques answer quality, and exposes grounded response traces for operators.
...
- Project type: `rag`
- Tags: rag, self-rag, llm, enterprise
